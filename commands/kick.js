...
module.exports = {
    ...
    async execute(interaction) {
        try {
            ...
            return interaction.reply({content: 'You don\'t have permissions to kick members.', ephemeral: true});

            if (!target_guild.kickable)
            return interaction.reply({content: 'This target cannot be kicked.', ephemeral: true});
